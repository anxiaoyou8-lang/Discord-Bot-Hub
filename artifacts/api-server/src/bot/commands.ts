...
export const commands = [
  ...
  new SlashCommandBuilder()
    .setName(BOT_SAY_CMD)
    .setDescription("以 Bot 身份发送消息，支持附件、回复、表情、艾特")
    .setDefaultMemberPermissions(ADMIN)
    .addChannelOption((opt) =>
      opt
        .setName("channel")
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("编辑 Bot 发送过的一条消息")
    .setDefaultMemberPermissions(ADMIN)
    .addStringOption((opt) =>
      opt
        .setName("message_id")
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("在当前频道发送闲话随机抽取面板")
    .setDefaultMemberPermissions(ADMIN),

  new SlashCommandBuilder()
    .setName(ADD_TRIVIA_CMD)
    .setDescription("添加一则闲话 / 冷知识")
    .setDefaultMemberPermissions(ADMIN),

  new SlashCommandBuilder()
    .setName(DELETE_TRIVIA_CMD)
    .setDescription("删除一则闲话")
    .setDefaultMemberPermissions(ADMIN)
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("列出所有闲话及其 ID")
    .setDefaultMemberPermissions(ADMIN),

  new SlashCommandBuilder()
    .setName(SUGGESTION_PANEL_CMD)
    .setDescription("在当前频道发送民众议会面板")
    .setDefaultMemberPermissions(ADMIN),

  new SlashCommandBuilder()
    .setName(SET_SUGGESTION_CHANNEL_CMD)
    .setDescription("设置接收意见箱工单的频道")
    .setDefaultMemberPermissions(ADMIN)
    .addChannelOption((opt) =>
  ...
  new SlashCommandBuilder()
    ...
    .setDescription("向当前作品帖的订阅者发送更新通知"),

  new SlashCommandBuilder()
    .setName(BAN_PANEL_CMD)
    .setDescription("在当前频道发送封禁管理面板")
    .setDefaultMemberPermissions(ADMIN),

  new SlashCommandBuilder()
    .setName(SET_BAN_CHANNEL_CMD)
    .setDescription("设置封禁公告发送的频道")
    .setDefaultMemberPermissions(ADMIN)
    .addChannelOption((opt) =>
